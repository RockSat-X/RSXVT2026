...
uint8_t receiverAddress[] = {0x10, 0xB4, 0x1D, 0xE8, 0x97, 0x28};//input MAC address of receiver here if using unicast
...
typedef struct __attribute__((packed)) struct_message {
    ...
    uint8_t payload[236]; // Data payload buffer
} struct_message;
...
//change if desired
const uint8_t currentPayloadSize = sizeof(myData.payload);
...
size_t packetSize = sizeof(myData.sequenceNum) + currentPayloadSize;
