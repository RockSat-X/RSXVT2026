...
void OnDataRecv(const esp_now_recv_info * info, const uint8_t *incomingData, int len) { // <-- CORRECTED PARAMETERS
    ...
    // Make copies of volatile variables used in checks if needed,
    // though simple reads/writes are often atomic for uint32_t on ESP32.
