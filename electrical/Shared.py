...
TARGETS = (
    ...
    types.SimpleNamespace(
        ...
        gpios = (
            ...
            ('swclk'                , 'A14', None       , {                                               }),
            ('button'               , 'C13', 'INPUT'    , { 'pull'    : None, 'active' : True             }),
            ('camera_data_0'        , 'C6' , 'ALTERNATE', { 'altfunc' : 'DCMI_D0'                         }),
            ('camera_data_1'        , 'C7' , 'ALTERNATE', { 'altfunc' : 'DCMI_D1'                         }),
            ('camera_data_2'        , 'B15', 'ALTERNATE', { 'altfunc' : 'DCMI_D2'                         }),
            ('camera_data_3'        , 'C9' , 'ALTERNATE', { 'altfunc' : 'DCMI_D3'                         }),
            ('camera_data_4'        , 'C11', 'ALTERNATE', { 'altfunc' : 'DCMI_D4'                         }),
            ('camera_data_5'        , 'B6' , 'ALTERNATE', { 'altfunc' : 'DCMI_D5'                         }),
            ('camera_data_6'        , 'B8' , 'ALTERNATE', { 'altfunc' : 'DCMI_D6'                         }),
            ('camera_data_7'        , 'B4' , 'ALTERNATE', { 'altfunc' : 'DCMI_D7'                         }),
            ('camera_pixel_clock'   , 'A6' , 'ALTERNATE', { 'altfunc' : 'DCMI_PIXCLK'                     }),
            ('camera_vsync'         , 'B7' , 'ALTERNATE', { 'altfunc' : 'DCMI_VSYNC'                      }),
            ('camera_hsync'         , 'A4' , 'ALTERNATE', { 'altfunc' : 'DCMI_HSYNC'                      }), # Note that SB22 should be shorted, SB3 and SB7 open.
            ('camera_power_down'    , 'A10', 'OUTPUT'   , { 'initlvl' : False                             }),
            ('camera_restart'       , 'C5' , 'OUTPUT'   , { 'initlvl' : False                             }),
            ('camera_external_clock', 'A8' , 'ALTERNATE', { 'altfunc' : 'TIM1_CH1', 'speed' : 'VERY_HIGH' }),
            ('camera_i2c_clock'     , 'B10', 'ALTERNATE', { 'altfunc' : 'I2C2_SCL'                        }),
            ('camera_i2c_data'      , 'B12', 'ALTERNATE', { 'altfunc' : 'I2C2_SDA'                        }),
        ),
        ...
        schema          = {
            ...
            'APB3_CK'                    : 240_000_000,
            'USART2_BAUD'                : STLINK_BAUD,
            'TIM1_UPDATE_RATE'           : 24_000_000,
            'TIM1_MAX_UPDATE_RATE_ERROR' : 0.001,
        },
