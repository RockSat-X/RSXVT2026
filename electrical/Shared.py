...
TARGETS = ( # @/`Defining Targets`.
    ...
    types.SimpleNamespace(
        ...
        gpios = (
            ...
            ('esp32_reset'                    , 'D10', 'OUTPUT'    , { 'initlvl' : False, 'active' : False, 'open_drain' : True }),
    ...
    types.SimpleNamespace(
        ...
        gpios = (
            ...
            ('openmv_reset'               , 'B2'  , 'OUTPUT'    , { 'initlvl' : False, 'active' : False, 'open_drain' : True }),
    ...
    types.SimpleNamespace(
        ...
        gpios = (
            ...
            ('testpoint_A'      , 'D7' , None       , {                                                 }),
            ('testpoint_B'      , 'A9' , None       , {                                                 }),
            ('sd_cmd'           , 'D2' , 'ALTERNATE', { 'altfunc' : 'SDMMC1_CMD', 'speed' : 'VERY_HIGH' }),
            ('sd_data_0'        , 'C8' , 'ALTERNATE', { 'altfunc' : 'SDMMC1_D0' , 'speed' : 'VERY_HIGH' }),
            ('sd_data_1'        , 'C9' , 'ALTERNATE', { 'altfunc' : 'SDMMC1_D1' , 'speed' : 'VERY_HIGH' }),
            ('sd_data_2'        , 'C10', 'ALTERNATE', { 'altfunc' : 'SDMMC1_D2' , 'speed' : 'VERY_HIGH' }),
            ('sd_data_3'        , 'C11', 'ALTERNATE', { 'altfunc' : 'SDMMC1_D3' , 'speed' : 'VERY_HIGH' }),
            ('sd_clock'         , 'C12', 'ALTERNATE', { 'altfunc' : 'SDMMC1_CK' , 'speed' : 'VERY_HIGH' }),
