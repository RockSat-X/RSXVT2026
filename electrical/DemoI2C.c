...
INTERRUPT_I2Cx_bee(enum I2CSlaveCallbackEvent event, u8* data)
{
    ...
    switch (event)
    {
        ...
        {
            case I2CSlaveCallbackEvent_master_initiates_read  : stlink_tx("Bee   : beginning to send data..."            "\n"); goto BEGINNING;
            case I2CSlaveCallbackEvent_master_initiates_write : stlink_tx("Bee   : getting data..."                      "\n"); goto BEGINNING;
            case I2CSlaveCallbackEvent_master_repeats_read    : stlink_tx("Bee   : beginning to send data... (repeated)" "\n"); goto BEGINNING;
            case I2CSlaveCallbackEvent_master_repeats_write   : stlink_tx("Bee   : getting data... (repeated)"           "\n"); goto BEGINNING;
            BEGINNING:;
